...
public class DocumentManagementTest extends BaseStep {
        ...
        public void navigateToDocumentManagementTabs() {
                ...
                WebElement buttonEmployeeDocumentRequests = BaseStep
                                .findElementXpathWithWait("//*[@id=\"rc-tabs-0-tab-employee\"]", TimeOut.LONG.value);
                ...
                WebElement buttonSendingbyManagement = BaseStep.findElementXpathWithWait(
                                "//div[contains(@id, 'sending-by-management') and @role='tab']", TimeOut.LONG.value);
                ...
                WebElement buttonManagementDocumentRequests = BaseStep
                                .findElementXpathWithWait("//*[@id=\"rc-tabs-0-tab-management\"]", TimeOut.LONG.value);
        ...
        public void navigateToTeamFiless() {
                ...
                WebElement searchBox11 = BaseStep.findElementXpathWithWait(
                                "//input[@placeholder='Çalışan adı veya numarası ile ara...']", TimeOut.LONG.value);
                ...
                WebElement searchBox2 = BaseStep.findElementXpathWithWait(searchInputXpath, TimeOut.LONG.value);
            ...
            WebElement companyTab = BaseStep.findElementXpathWithWait("//div[@data-node-key='company-files']", TimeOut.LONG.value);
            ...
            LogTest.info("Arama işlemi tetiklendi.");
                ...
                WebElement fileSearchBox = BaseStep.findElementXpathWithWait(searchInputXpath4, TimeOut.LONG.value);
            ...
            LogTest.info("Birim başarıyla seçildi.");
                ...
                WebElement createButton = BaseStep.findElementXpathWithWait(addNewFileBtnXpath, TimeOut.LONG.value);
                ...
                WebElement docNameInput = BaseStep.findElementXpathWithWait(docNameFieldXpath, TimeOut.LONG.value);
                ...
                WebElement unitSelectionContainer = BaseStep.findElementXpathWithWait(modalUnitDropdownXpath, TimeOut.LONG.value);
                ...
                WebElement departmentOption = BaseStep.findElementXpathWithWait(targetDepartmentOptionXpath, TimeOut.LONG.value);
                ...
                WebElement uploadBtn = BaseStep.findElementXpathWithWait("//div[contains(@class, 'ant-modal-content')]//button[.//span[text()='Yükle']]", TimeOut.LONG.value);
