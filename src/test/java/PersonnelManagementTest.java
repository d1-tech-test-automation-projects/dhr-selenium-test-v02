...
public class PersonnelManagementTest extends BaseStep {
    ...
    public void navigateToEmployeeManagement() {
        ...
        WebElement employeeManagementDropdown = BaseStep.findElementXpathWithWait("//li[@class='ant-menu-submenu ant-menu-submenu-inline ant-menu-submenu-open ant-menu-submenu-selected']//div[@role='menuitem']", TimeOut.SHORT.value);
        ...
        WebElement buttonEmployeeManagement = BaseStep.findElementXpathWithWait("//a[@href='/employee-management']", TimeOut.SHORT.value);
    ...
    public void searchEmployee() {
        ...
        WebElement buttonSearch = BaseStep.findElementXpathWithWait("//*[@id=\"root\"]/div/section/section/main/div/div/div/div/div[2]/div[1]/div[1]/span/input", TimeOut.SHORT.value);
    ...
    public void filterEmployee() {
        ...
        WebElement buttonfilter = BaseStep.findElementXpathWithWait("//*[@id=\"root\"]/div/section/section/main/div/div/div/div/div[2]/div[1]/div[2]/button", TimeOut.SHORT.value);
        ...
        WebElement roleSelector = BaseStep.findElementXpathWithWait("//span[text()='Rol seçin']/ancestor::div[contains(@class, 'ant-select-selector')]", TimeOut.SHORT.value);
        ...
        WebElement roleInput = BaseStep.findElementXpathWithWait("//div[contains(@class, 'ant-select-item-option-content') and text()='Manager']", TimeOut.SHORT.value);
        BaseStep.clickElement(roleInput, "Rol Input Odaklanma");
        BaseStep.waitSeconds(2);

        BaseStep.waitSeconds(1);
        LogTest.info("Organizasyon Birimi seçiliyor...");
        WebElement organizationUnitButton = BaseStep.findElementXpathWithWait("//span[text()='Birim seçin']/ancestor::div[contains(@class, 'ant-select-selector')]", TimeOut.SHORT.value);
        BaseStep.clickElement(organizationUnitButton, "Organizasyon Birimi kutusu açıldı");
        BaseStep.waitSeconds(1);

        BaseStep.waitSeconds(1);
        LogTest.info("Listeden birim seçiliyor:...");
        WebElement d1tech = BaseStep.findElementXpathWithWait("//div[contains(@class, 'ant-select-item-option-content') and text()='D1-Tech']", TimeOut.SHORT.value);
        BaseStep.clickElement(d1tech, "Birim seçimi tamamlandı");
        BaseStep.waitSeconds(1);

        BaseStep.waitSeconds(1);
        LogTest.info("Pozisyon seçiliyor...");
        WebElement positionButton = BaseStep.findElementXpathWithWait("//input[@id='positions']/ancestor::div[contains(@class, 'ant-select-selector')]", TimeOut.SHORT.value);
        BaseStep.clickElement(positionButton, "Pozisyonlar dropdown kutusu açıldı");
        BaseStep.waitSeconds(1);

        BaseStep.waitSeconds(1);
        LogTest.info("Listeden İk:...");
        WebElement ik = BaseStep.findElementXpathWithWait("//div[contains(@class, 'ant-select-item-option-content') and text()='İK']", TimeOut.SHORT.value);
        BaseStep.clickElement(ik, "Pozisyon seçimi başarıyla tamamlandı.");
        BaseStep.waitSeconds(1);

        BaseStep.waitSeconds(1);
        LogTest.info("durum seçiliyor...");
        WebElement statusButton = BaseStep.findElementXpathWithWait("//input[@id='status']/ancestor::div[contains(@class, 'ant-select-selector')]", TimeOut.SHORT.value);
        BaseStep.clickElement(statusButton, "durum dropdown kutusu açıldı");
        BaseStep.waitSeconds(1);

        BaseStep.waitSeconds(1);
        LogTest.info("Aktif seçeneği seçilecek.");
        WebElement activeOption = BaseStep.findElementXpathWithWait("//div[contains(@class, 'ant-select-item-option-content') and text()='Aktif']", TimeOut.SHORT.value);
        BaseStep.clickElement(activeOption, "Aktif seçeneği seçildi");
        BaseStep.waitSeconds(2);

        WebElement statusInput = findElementXpathWithWait("//input[@id='status']", TimeOut.SHORT.value);
        ...
        WebElement temizleBtn = findElementXpathWithWait(clearBtnXpath, TimeOut.SHORT.value);
        ...
        WebElement okButton = BaseStep.findElementXpathWithWait("//button//span[text()='Tamam']/ancestor::button", TimeOut.SHORT.value);
    ...
    public void dismissEmployee() {
        ...
        WebElement dismissButton = findElementXpathWithWait("//button[.//span[contains(@class, 'anticon-user-delete')]]", TimeOut.SHORT.value);
        ...
        WebElement dismissEmployeeButton = findElementXpathWithWait("//button[contains(., 'Çalışanı İşten Çıkar')]", TimeOut.SHORT.value);
        ...
        WebElement employeeDropdown = findElementXpathWithWait("//span[contains(text(),'Çalışan seçin')]/ancestor::div[contains(@class, 'ant-select-selector')]", TimeOut.SHORT.value);
        BaseStep.clickElement(employeeDropdown, "Çalışan listesi açıldı");
        waitSeconds(1);
        LogTest.info("Listeden bir çalışan seçiliyor...");
        WebElement selectedEmployee = findElementXpathWithWait("//div[contains(@class, 'ant-select-item-option-content') and contains(., 'Hakan Güzel')]", TimeOut.SHORT.value);
        ...
        WebElement reasonDropdown = findElementXpathWithWait("//input[@id='terminationReasonDefinitionId']/ancestor::div[contains(@class, 'ant-select-selector')]", TimeOut.SHORT.value);
        BaseStep.clickElement(reasonDropdown, "Sebep listesi açıldı");
        waitSeconds(1);
        LogTest.info("Sebep seçiliyor: 1-Atendance Issues");
        WebElement option = findElementXpathWithWait("(//div[contains(@class, 'ant-select-item-option-content') and contains(., '1 - Attendance Issues')])[last()]", TimeOut.SHORT.value);
        ...
        WebElement descriptionField = findElementXpathWithWait("//textarea[@id='comments']", TimeOut.SHORT.value);
    ...
    public void addNewEmployee() {
        ...
        WebElement newEmployeeButton = findElementXpathWithWait("//button[.//span[text()='Yeni Çalışan Ekle']]", TimeOut.SHORT.value);
        ...
        WebElement employeeNumberField = findElementXpathWithWait("//input[@id='employeeNumber']", TimeOut.SHORT.value);
        ...
        WebElement firstNameField = findElementXpathWithWait("//input[@id='firstName']", TimeOut.SHORT.value);
        firstNameField.clear();
        firstNameField.sendKeys("Sude");
        LogTest.info("Ad başarıyla girildi: ");

        LogTest.info("Çalışan soyadı giriliyor...");
        WebElement lastNameField = findElementXpathWithWait("//input[@id='lastName']", TimeOut.SHORT.value);
        lastNameField.clear();
        lastNameField.sendKeys("Çinay");
        LogTest.info("Soyad başarıyla girildi: ");

        LogTest.info("Çalışan e-postası giriliyor...");
        WebElement emailField = findElementXpathWithWait("//input[@id='email']", TimeOut.SHORT.value);
        emailField.clear();
        ...
        WebElement genderDropdown = findElementXpathWithWait("//input[@id='gender']/ancestor::div[contains(@class, 'ant-select-selector')]", TimeOut.SHORT.value);
        BaseStep.clickElement(genderDropdown, "Cinsiyet listesi açıldı");
        waitSeconds(1);
        LogTest.info("Cinsiyet seçiliyor: Kadın");
        WebElement femaleOption = findElementXpathWithWait("//div[contains(@class, 'ant-select-item-option-content') and text()='Kadın']", TimeOut.SHORT.value);
        ...
        WebElement phoneField = findElementXpathWithWait("//input[@id='phoneNumber']", TimeOut.SHORT.value);
        phoneField.clear();
        phoneField.sendKeys("5554443322");
        LogTest.info("Telefon numarası başarıyla girildi: ");

        LogTest.info("Takvim açılıyor...");
        WebElement tarihInput = findElementXpathWithWait("//input[@placeholder='Doğum tarihi girin (GG-AA-YYYY)']", TimeOut.SHORT.value);
        BaseStep.clickElement(tarihInput, "Tarih alanına tıklandı");
        waitSeconds(1);
        WebElement tarihInput2 = BaseStep.findElementXpathWithWait("//input[@placeholder='Doğum tarihi girin (GG-AA-YYYY)']", TimeOut.SHORT.value);
        ...
        WebElement organizationTab = findElementXpathWithWait("//div[@data-node-key='2']", TimeOut.SHORT.value);
        ...
        WebElement departmentDropdown = findElementXpathWithWait("//input[@id='organizationalUnitId']", TimeOut.SHORT.value);
        BaseStep.clickElement(departmentDropdown, "Departman listesi açıldı");
        waitSeconds(1);
        WebElement crmtest = BaseStep.findElementXpathWithWait("//input[@id='organizationalUnitId']", TimeOut.SHORT.value);
        ...
        WebElement saveButton = findElementXpathWithWait("//button[@type='submit']//span[text()='Kaydet']", TimeOut.SHORT.value);
